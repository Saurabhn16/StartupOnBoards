...
import "./Blog.css";
import { FaHeart, FaRegHeart, FaComment, FaUserCircle } from "react-icons/fa"; // Import necessary icons
...
const Blog = () => {
  ...
  // Function to check if user has liked a blog post
  ...
  return (
    <div className="max-w-3xl mx-auto py-8 px-4">
      <h1 className="text-4xl font-bold mb-6 text-center">Startup Blog</h1>
